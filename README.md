...
or prepared PDFs. Fitting preserves each page as a PDF Form XObject rather than
rasterising it, retaining text, vectors, images, masks, transparency, and layers.
Printable annotations and form widgets are baked into the page before fitting.
